                ...
                case R.id.Popup_Item_Delete:
                    if (mEvent.isRecurring()) {
                        new AlertDialog.Builder(context)
                                .setTitle("Supprimer un événement récurrent")
                                .setMessage("Voulez-vous vraiment supprimer cet événement récurrent ? Toutes les occurrences de cet événement seront également supprimées.")
