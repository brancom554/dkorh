...
public class NewEventActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        setTimeTextView.setText(new SimpleDateFormat("K:mm a", Locale.FRANCE).format(calendar.getTime()));
    ...
    private boolean confirmInputs() {
        ...
        if (!validateNotifications()) {
            Snackbar.make(addNotificationTextView, "Vous ne pouvez pas définir une notification dans le passé", BaseTransientBottomBar.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
