...
public class UserSettingsFragment extends Fragment {
    ...
    private Button ringToneCardView;
    private Button reminderTimeCardView;
    private Button reminderFrequencyCardView;
    private Button appThemeCardView;
    ...
    private void defineViews(View view) {
        ...
        ringtoneTextView = (TextView) view.findViewById(R.id.UserSettingsFragment_TextView_UserSettingsx);
    ...
    private void restartApp() {
        startActivity(new Intent(getActivity(), Evennement.class));
        getActivity().finish();
    }
