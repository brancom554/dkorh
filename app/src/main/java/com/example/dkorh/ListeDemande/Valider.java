...
public class Valider extends Fragment {
    RecyclerView rv;
    String info;
    String id;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_valider, container, false);
        ...
        String jsonURL=config.lien+"?view=getAbsences&employee_id="+id+"&type=1";
