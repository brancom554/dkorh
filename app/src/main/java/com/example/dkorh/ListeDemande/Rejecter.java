...
public class Rejecter extends Fragment {
    RecyclerView rv;
    String info;
    String id;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_rejecter, container, false);
        ...
        String jsonURL=config.lien+"?view=getAbsences&employee_id="+id+"&type=0";
